...
Çalıştırmak için: python gitlab_reviewer.py
"""
...
# --- AYARLAR ---
GITLAB_URL        = "http://gitlab.sirket.local"   # Şirket içi GitLab adresi
GITLAB_TOKEN      = os.environ.get("GITLAB_TOKEN", "")  # Ortam değişkeninden al
...
def webhook():
    ...
    if event != "Push Hook":
        return "OK", 200  # Sadece push event'larını işle

    # Payload'dan bilgileri çıkar
